    ...
    <div className="container">
      <div className="server-title">
        ...
        <div className="server-icon">
          <img className="earth a-downup" src={iconEarth} alt="" />
        </div>
      </div>
        ...
        <div className="introdution-box">
          ...
          <div className="ib-content">
            ...
            <Button
              ...
              link="/pages/reservations/ReservationIndex"
              buttonText="立即預約"
            />
          </div>
        </div>
      ...
      <div className="fqa">
        <div className="fqa-title">
          <p className="title fontcolor-b">常見 Q&amp;A</p>
        </div>
      ...
      <div className="store-location">
        <div className="sl-title">
          <p className="title foncolor-b">門市位置</p>
        </div>
