  ...
  return (
    <div className="boarding-pass-mobile-wrapper" style={{ fontSize: '12px' }}>
      <img
        ...
        src={bookingId ? boardingPassStampMobile : boardingPassMobile}
        alt="boarding pass"
      />
      <div className="booking-info-wrapper-m">
        ...
        <div className="booking-main-info-row-m">
          ...
          <div className="booking-info-content-m">{bookingName}</div>
        </div>
        <div className="booking-main-info-row-m">
          <div className="booking-info-title-m">訂單成立日</div>
          <div className="booking-info-content-m">{orderPlaceDate}</div>
        </div>
        <div className="booking-main-info-row-m">
          <div className="booking-info-title-m">聯絡資訊</div>
          <div className="booking-info-content-m">{bookingContact}</div>
        </div>
        <div className="booking-main-info-row-m">
          <div className="booking-info-title-m">人數</div>
          <div className="booking-info-content-m">{people} 人</div>
        </div>
        <div className="booking-main-info-row-m">
          <div className="booking-info-title-m">訂位日期</div>
          <div className="booking-info-content-m">{bookingDate}</div>
        </div>
        <div className="booking-main-info-row-m">
